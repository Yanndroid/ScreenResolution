...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initToolbar();
        settilte(getResources().getString(R.string.screen_resolution_title));
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (checkedId) {
                    case R.id.resolution_low:
                        resolution_summary.setText(R.string.screen_resolution_hd_description);
                        resolution_low.setTypeface(Typeface.DEFAULT_BOLD);
                        break;
                    case R.id.resolution_medium:
                        resolution_summary.setText(R.string.screen_resolution_fhd_description);
                        resolution_medium.setTypeface(Typeface.DEFAULT_BOLD);
                        break;
                    case R.id.resolution_high:
                        resolution_summary.setText(R.string.screen_resolution_wqhd_description);
        ...
        resolution_apply.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    switch (resolution) {
                        case R.id.resolution_low:
                            setResolution(getString(R.string.screen_resolution_hd_px), getString(R.string.screen_resolution_hd_dpi));
                            break;
                        case R.id.resolution_medium:
                            setResolution(getString(R.string.screen_resolution_fhd_px), getString(R.string.screen_resolution_fhd_dpi));
                            break;
                        case R.id.resolution_high:
